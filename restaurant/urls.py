...
from .views import RestaurantRegisterView, RestaurantLoginView, MenuCreateListView, TableCreateView, PaymentCreateView, TimingView, SeatsCreateView, SeatSlotView, GalleryView, PerformanceView, OfferView, DiningOfferView, TableConfigView, CreateServerView

urlpatterns = [
    path('signup/', RestaurantRegisterView.as_view(), name="restaurants"),
    path('restaurants/<int:pk>/', RestaurantRegisterView.as_view(), name='restaurant-update'),
    ...
    path('performance/<int:pk>/', PerformanceView.as_view(), name='performance-detail'),
    ...
    path('server/<int:pk>/', CreateServerView.as_view(), name='server-detail'),
