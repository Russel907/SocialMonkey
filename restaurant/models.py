...
class Table(models.Model):
    ...
    qr_code = models.ImageField(upload_to='static/qrcodes/', null=True, blank=True, default='static/qrcodes/static_qr_placeholder.png')
...
class Gallery(models.Model):
    ...
    def __str__(self):
        return f"Image for {self.restaurant.name} - {self.caption or 'No caption'}"
